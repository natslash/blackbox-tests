...
public class MqttExampleOptions {
  ...
  public static MqttExampleOptions fromFlags(String[] args) {
    ...
    options.addOption(Option.builder().type(String.class).longOpt("mqtt_bridge_hostname").hasArg()
        .desc("MQTT bridge hostname.").build());
    ...
    options.addOption(Option.builder().type(Number.class).longOpt("mqtt_bridge_port").hasArg()
        .desc("MQTT bridge port.").build());
    options.addOption(Option.builder().type(String.class).longOpt("message_type").hasArg()
        ...
        .build());
    options.addOption(Option.builder().type(Number.class).longOpt("wait_time").hasArg()
        .desc("Wait time (in seconds) for commands.").build());
